...
linux* | k*bsd*-gnu | kopensolaris*-gnu)
  ...
  # Extract search path from ldconfig, see https://lists.gnu.org/archive/html/libtool-patches/2010-06/msg00145.html
  ldconfig_search_path=`/sbin/ldconfig -N -X -v 2>/dev/null|sed 's,^\(/.*\):\( (.*)\)\?$,\1,p;d' | tr '\n' ' '`
    ...
    *)
	...
	case $cc_basename in
	  ...
	  *)
	    ...
	    *Cray\ C* | Fortan*)
	      # Cray compiler
	      _LT_TAGVAR(lt_prog_compiler_pic, $1)='-h pic'
	      _LT_TAGVAR(lt_prog_compiler_static, $1)='-static'
	      _LT_TAGVAR(lt_prog_compiler_wl, $1)='-Wl,'
	      ;;
	    *Fujitsu*)
