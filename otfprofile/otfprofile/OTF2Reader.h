...
public:
    ...
    bool open( AllData& alldata );
    void close();
    bool assignProcs( AllData& alldata );
...
private:
    ...
    handle_enter( OTF2_LocationRef    locationID,
                  OTF2_TimeStamp      time,
                  void*               userData,
     ...
     */
    static inline OTF2_CallbackCode
    handle_leave( OTF2_LocationRef    locationID,
                  OTF2_TimeStamp      time,
                  void*               userData,
                  OTF2_AttributeList* attributeList,
                  OTF2_RegionRef      region );
     ...
     */
    static inline OTF2_CallbackCode
    handle_mpi_send( OTF2_LocationRef    locationID,
                     OTF2_TimeStamp      time,
                     void*               userData,
                     OTF2_AttributeList* attributeList,
                     uint32_t            receiver,
     ...
     */
    static inline OTF2_CallbackCode
    handle_mpi_isend( OTF2_LocationRef    locationID,
                      OTF2_TimeStamp      time,
                      void*               userData,
                      OTF2_AttributeList* attributeList,
                      uint32_t            receiver,
     ...
     */
    static inline OTF2_CallbackCode
    handle_mpi_isend_complete( OTF2_LocationRef    locationID,
                               OTF2_TimeStamp      time,
                               void*               userData,
                               OTF2_AttributeList* attributeList,
                               uint64_t            requestID );
     ...
     */
    static inline OTF2_CallbackCode
    handle_mpi_recv( OTF2_LocationRef    locationID,
                        OTF2_TimeStamp      time,
                        void*               userData,
                        OTF2_AttributeList* attributeList,
                        uint32_t            sender,
     ...
     */
    static inline OTF2_CallbackCode
    handle_mpi_irecv_request( OTF2_LocationRef    locationID,
                              OTF2_TimeStamp      time,
                              void*               userData,
                              OTF2_AttributeList* attributeList,
                              uint64_t            requestID );
     ...
     */
    static inline OTF2_CallbackCode
    handle_mpi_irecv( OTF2_LocationRef    locationID,
                      OTF2_TimeStamp      time,
                      void*               userData,
                      OTF2_AttributeList* attributeList,
                      uint32_t            sender,
     ...
     */
    static inline OTF2_CallbackCode
    handle_buffer_flush( OTF2_LocationRef    locationID,
                         OTF2_TimeStamp      time,
                         void*               userData,
                         OTF2_AttributeList* attributeList,
     ...
     */
    static inline OTF2_CallbackCode
    handle_mpi_request_test( OTF2_LocationRef    locationID,
                             OTF2_TimeStamp      time,
                             void*               userData,
                             OTF2_AttributeList* attributeList,
                             uint64_t            requestID );
     ...
     */
    static inline OTF2_CallbackCode
    handle_mpi_collective_begin( OTF2_LocationRef    locationID,
                                 OTF2_TimeStamp      time,
                                 void*               userData,
                                 OTF2_AttributeList* attributeList );
     ...
     */
    static inline OTF2_CallbackCode
    handle_mpi_collective_end( OTF2_LocationRef         locationID,
                               OTF2_TimeStamp           time,
                               void*                    userData,
                               OTF2_AttributeList*      attributeList,
     ...
     */
    static inline OTF2_CallbackCode
    handle_omp_fork( OTF2_LocationRef    locationID,
                     OTF2_TimeStamp      time,
                     void*               userData,
                     OTF2_AttributeList* attributeList,
     ...
     */
    static inline OTF2_CallbackCode
    handle_omp_join( OTF2_LocationRef    locationID,
                     OTF2_TimeStamp      time,
                     void*               userData,
                     OTF2_AttributeList* attributeList );
     ...
     */
    static inline OTF2_CallbackCode
    handle_omp_acquire_lock( OTF2_LocationRef    locationID,
                             OTF2_TimeStamp      time,
                             void*               userData,
                             OTF2_AttributeList* attributeList,
                             uint32_t            lockID,
     ...
     */
    static inline OTF2_CallbackCode
    handle_omp_release_lock( OTF2_LocationRef    locationID,
                             OTF2_TimeStamp      time,
                             void*               userData,
                             OTF2_AttributeList* attributeList,
                             uint32_t            lockID,
     ...
     */
    static inline OTF2_CallbackCode
    handle_omp_task_create( OTF2_LocationRef    locationID,
                            OTF2_TimeStamp      time,
                            void*               userData,
                            OTF2_AttributeList* attributeList,
                            uint64_t            taskID );
     ...
     */
    static inline OTF2_CallbackCode
    handle_omp_task_switch( OTF2_LocationRef    locationID,
                            OTF2_TimeStamp      time,
                            void*               userData,
                            OTF2_AttributeList* attributeList,
                            uint64_t            taskID );
     ...
     */
    static inline OTF2_CallbackCode
    handle_omp_task_complete( OTF2_LocationRef    locationID,
                              OTF2_TimeStamp      time,
                              void*               userData,
                              OTF2_AttributeList* attributeList,
                              uint64_t            taskID );
     ...
     */
    static inline OTF2_CallbackCode
    handle_metric( OTF2_LocationRef        locationID,
                   OTF2_TimeStamp          time,
                   void*                   userData,
                   OTF2_AttributeList*     attributeList,
    ...
    /** @brief Callback for an rma put event record.
     *
     *  @param locationID        The location where this event happened.
     *  @param time              The time when this event happened.
     *  @param userData          User data.
     *  @param attributeList     Additional attributes for this event.
     *  @param win               ID of the window used for this operation.
     *  @param remote            Rank of the target process.
     *  @param bytes             Bytes put.
     *  @param matchingId        42, not kidding.
     *
     *  @return @eref{OTF2_CALLBACK_SUCCESS} or @eref{OTF2_CALLBACK_INTERRUPT}.
     */

    static inline OTF2_CallbackCode
    handle_rma_put( OTF2_LocationRef    locationID,
                    OTF2_TimeStamp      time,
                    void*               userData,
                    OTF2_AttributeList* attributeList,
                    OTF2_RmaWinRef      win,
    ...
    /** @brief Callback for an rma get event record.
     *
     *  @param locationID        The location where this event happened.
     *  @param time              The time when this event happened.
     *  @param userData          User data.
    ...
    static inline OTF2_CallbackCode
    handle_rma_get(               OTF2_LocationRef    locationID,
                                  OTF2_TimeStamp      time,
                                  void*               userData,
                                  OTF2_AttributeList* attributeList,
                                  OTF2_RmaWinRef      win,
     ...
     */
    static inline OTF2_CallbackCode
    handle_unknown( OTF2_LocationRef    locationID,
                    OTF2_TimeStamp      time,
                    void*               userData,
                    OTF2_AttributeList* attributeList );
    ...
    /** @brief Callback for a MetricClass definition record.
     *
     *  @param userData          User data.
     *  @param self              Unique identifier for this MetricClass
     ...
     *  @param metricOccurence   Defines occurence of a metric set.
     *  @param recorderKind      What kind of locations will record this metric.
     *
     *  @return @eref{OTF2_CALLBACK_SUCCESS} or @eref{OTF2_CALLBACK_INTERRUPT}.
     */
    static inline OTF2_CallbackCode
    handle_def_metric_class(    void*                       userData,
                                OTF2_MetricRef              self,
                                uint8_t                     numberOfMetrics,
     ...
     *  @param base              The recorded values should be handled in this 
     *                           given base (binary/decimal).
     *  @param exponent          The values inside the Metric events should be 
     *                           scaled by the factor base^exponent.
     *  @param unit              Unit of the metric. References a String 
     *                           definition.
     *
     *  @return @eref{OTF2_CALLBACK_SUCCESS} or @eref{OTF2_CALLBACK_INTERRUPT}.
     */
    static inline OTF2_CallbackCode
    handle_def_metrics(       void*                   userData,
     ...
     */
    static inline OTF2_CallbackCode
    handle_def_clock_properties( void*    userData,
    ...
    static inline OTF2_CallbackCode
    handle_def_location_group( void*                  userData,
     ...
     */
    static inline OTF2_CallbackCode
    handle_def_location( void*                 userData,
     ...
     */
    static inline OTF2_CallbackCode
    handle_def_group( void*           userData,
     ...
     */
    static inline OTF2_CallbackCode
    handle_def_region( void*           userData,
     ...
     *  @param name                     Free form instance name of this node. References String definition.
     ...
     */
    static inline OTF2_CallbackCode
    handle_def_system_tree_node( void*                  userData,
                                 OTF2_SystemTreeNodeRef systemTreeIdentifier,
                                 OTF2_StringRef         name,
                                 OTF2_StringRef         className,
                                 OTF2_SystemTreeNodeRef parent );

    /** @brief Callback which is triggered by a Comm definition record.
     *
     *  @param userData	           User data.
     *  @param self                The unique identifier for this Comm definition.
     *  @param name	               Name given by calling MPI_Comm_set_name on this communicator.
     *                             Or the empty name to inidcate no name was given.
     *                             References a String definition.
     *  @param group               The describing MPI group of this MPI communicator.
     *                             References a Group definition.
     *  @param parent              The parent MPI communicator from which this communicator was created.
     *                             References a Group definition.
     *
     *  @return @eref{OTF2_CALLBACK_SUCCESS} or @eref{OTF2_CALLBACK_INTERRUPT}.
     */
     ...
     */
    static inline OTF2_CallbackCode
    handle_def_string( void*          userData,
